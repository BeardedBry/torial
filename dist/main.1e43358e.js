...
function (_Phaser$Scene) {
  ...
  _createClass(LoadScene, [{
    ...
    value: function create() {
      this.scene.start(_CST.CST.SCENES.MENU, "Hello from load scene"); // Passes "Hello" message to MENU's init method.
    }
  }]);
...
function (_Phaser$Scene) {
  ...
  _createClass(MenuScene, [{
    ...
    value: function create() {
      ...
      optionsButton.setInteractive(); // Play button
      ...
      optionsButton.on("pointerup", function () {
        _this.scene.launch(_CST.CST.SCENES.OPTIONS, "Options");
      });
    }
  }]);
